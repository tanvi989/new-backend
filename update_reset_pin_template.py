#!/usr/bin/env python3
"""
Update MSG91 reset PIN email template
"""
import requests
import json
import os
...
def update_template():
    """
    Update the reset PIN email template in MSG91
    """
    print("=" * 80)
    print("UPDATING MSG91 RESET PIN EMAIL TEMPLATE")
    print("=" * 80)
    ...
    payload = {
        "template_name": "Reset PIN Template",
        "template_html": NEW_TEMPLATE_HTML,
        "template_text": "Use this code to reset your Multifolks PIN: {{OTP}}",
...
def test_template():
    ...
    """
    print("\n" + "=" * 80)
    print("TESTING UPDATED RESET PIN TEMPLATE")
    print("=" * 80)
...
if __name__ == "__main__":
    print("MSG91 Reset PIN Template Updater")
    print("This script will update the reset PIN email template in MSG91")
