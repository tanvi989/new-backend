#!/usr/bin/env python3
"""
Update MSG91 request_otp_new email template
"""
import requests
import json
import os
...
# Your new HTML template content
...
if __name__ == "__main__":
    print("MSG91 Request OTP Template Updater")
    print("This script will test the request_otp_new template")
    
    print("\n" + "=" * 80)
    print("TEMPLATE INFORMATION")
    print("=" * 80)
    print(f"Template ID: {TEMPLATE_ID}")
    print(f"This is now the template used for password reset PIN emails")
    print("Backend configuration has been updated to use this template")
