...
def test_payment_success_flow():
    ...
    create_order_url = f"https://testbackend.multifolks.com/api/v1/orders/create-from-payment/{order_id}"
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            email_url = f"https://testbackend.multifolks.com/api/v1/orders/{order_id}/send-confirmation-email"
